    ...
    <div class="table-scrollable">
        <table class="table table-striped table-bordered table-hover table-checkable dataTable">
            ...
            <tr class="heading">
                ...
                <?php } ?>
                <th class="hidden-mobile" width="60" style="text-align:center"> <?php echo dr_lang('排序'); ?> </th>
            ...
            <tbody>
            <?php $top=array();  if (is_array($data)) { $count=count($data);foreach ($data as $t) {  $t['pid'] == 0 && $top[] = $t['id']; ?>
