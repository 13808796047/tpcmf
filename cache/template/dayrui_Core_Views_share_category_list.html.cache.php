...
<form class="form-horizontal" role="form" id="myform">
    ...
    <div class="row fc-list-footer table-checkable ">
        <div class="col-md-12 fc-list-select">
            ...
            <?php }  if (IS_SHARE) { ?>
            <label><button type="button" onclick="dr_bfb('<?php echo dr_lang('生成共享栏目'); ?>', '', '<?php echo dr_url('html/category_index'); ?>')" class="btn green btn-sm"> <i class="fa fa-reorder"></i> <?php echo dr_lang('生成静态'); ?> </button></label>
            <?php } else { ?>
            <label><button type="button" onclick="dr_bfb('<?php echo dr_lang('生成栏目'); ?>', '', '<?php echo dr_url('html/category_index'); ?>&app=<?php echo APP_DIR; ?>')" class="btn green btn-sm"> <i class="fa fa-reorder"></i> <?php echo dr_lang('生成静态'); ?> </button></label>
            <?php } ?>
        </div>
    </div>
</form>
