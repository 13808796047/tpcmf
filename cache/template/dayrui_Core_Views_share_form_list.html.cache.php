    ...
    <div class="table-scrollable">
        <table class="table table-striped table-bordered table-hover table-checkable dataTable">
            ...
            <tr class="odd gradeX" id="dr_row_<?php echo $t['id']; ?>">
                ...
                <?php } ?>
                <td style="text-align:center"> <input type="text" onblur="dr_ajax_save(this.value, '<?php echo dr_url($uriprefix.'/edit_order', ['id'=>$t['id']]); ?>')" value="<?php echo $t['displayorder']; ?>" class="displayorder form-control input-sm input-inline input-mini"> </td>
                ...
                <td>
                    ...
                    <label><a href="JavaScript:;" onclick="dr_ajax_confirm_url('<?php echo dr_url('copy/home/form_edit', ['dir'=>$form_table,'id'=>$t['id']]); ?>', '<?php echo dr_lang('复制将把此内容生成一条新内容'); ?>', '<?php echo dr_now_url(); ?>')" class="btn btn-xs green"> <i class="fa fa-copy"></i> <?php echo dr_lang('复制'); ?></a></label>
                    <?php } ?>
                    <label><a href="<?php echo dr_url($uriprefix.'/show_index', ['id'=>$t['id']]); ?>" class="btn btn-xs dark"> <i class="fa fa-search"></i> <?php echo dr_lang('查看'); ?></a></label>
                </td>
            </tr>
            <?php } } ?>
            </tbody>
