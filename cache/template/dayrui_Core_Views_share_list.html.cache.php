        ...
        <table class="table table-striped table-bordered table-hover table-checkable dataTable">
            ...
            <tr class="odd gradeX" id="dr_row_<?php echo $t['id']; ?>">
                ...
                <td style="overflow:visible">
                    ...
                    <label><a class="btn blue btn-xs" href="<?php echo dr_url(APP_DIR.'/'.$a['table'].'/index', ['cid'=>$t['id']]); ?>"><i class="<?php echo dr_icon($a['setting']['icon']); ?>"></i> <?php echo dr_lang($a['name']);  if ($a['field']) { ?> (<?php echo intval($t[$a['table'].'_total']); ?>) <?php } ?> </a></label>
            ...
            <label>
                <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="<?php echo str_replace(array('{mid}'), array(APP_DIR), $a['url']); ?>"> <i class="<?php echo $a['icon']; ?>"></i> <?php echo dr_lang($a['name']); ?> </a>
                        </li>
                        <?php }  } } ?>
